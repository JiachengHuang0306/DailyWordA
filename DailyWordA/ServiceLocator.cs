...
public class ServiceLocator {
    ...
    public TodayCourseViewModel TodayCourseViewModel =>
        _serviceProvider.GetRequiredService<TodayCourseViewModel>();
    
    public QueryCourseViewModel QueryCourseViewModel =>
        _serviceProvider.GetRequiredService<QueryCourseViewModel>();
